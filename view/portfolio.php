            ...
            <div class="col-md-12">
                ...
                <div class="col-md-4 colPort">
                    <div class="portZoom artesanato">
                        <img src="<?php echo Conf::IMAGENS;?>portfolio/artesanatoBanner.jpg" alt="Banner artesanato Uifer Calhas" title="Artesanato Uifer Calhas"/>
                        <div class="retina">
                            <div>
                ...
                <div class="col-md-4 colPort">
                    <div class="portZoom calhas">
                        <img src="<?php echo Conf::IMAGENS;?>portfolio/calhasBanner.jpg" alt="Banner calhas Uifer Calhas" title="Calhas Uifer Calhas"/>
                        <div class="retina">
                            <div>
                ...
                <div class="col-md-4 colPort">
                    <div class="portZoom funilaria">
                        <img src="<?php echo Conf::IMAGENS;?>portfolio/funilariaBanner.jpg" alt="Banner funilaria industrial Uifer Calhas" title="Funilaria Industrial Uifer Calhas"/>
                        <div class="retina">
                            <div>
...
<!--Portfolio CSS-->
<link href="<?php echo Conf::CSS; ?>portfolio.css" rel="stylesheet" type="text/css"/>