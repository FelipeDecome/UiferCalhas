...
<html lang="pt-br">
    <head>
        ...
        <!--JQUERY-->
        <script src="<?php echo JS; ?>jquery-3.1.1.min.js" type="text/javascript"></script>
...
<!--CSS HEADER-->
<link href="<?php echo CSS; ?>header.css" rel="stylesheet" type="text/css"/>

<!--CONTATO CSS-->
<link href="<?php echo CSS; ?>contato.css" rel="stylesheet" type="text/css"/>

<!--FOOTER CSS-->
<link href="<?php echo CSS; ?>footer.css" rel="stylesheet" type="text/css"/>

<!--Navbar JS-->
<script src="<?php echo JS; ?>navbarAutomation.js" type="text/javascript"></script>  